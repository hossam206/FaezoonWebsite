...
export default function Hadith() {
  ...
  const AllHadith = useSelector((state) => state.fetchedData.results);
  ...
  const debouncedFetch = _.debounce((searchValue) => {
    dispatch(
      fetchSearchResult({ path: "/hadiths/search", searchWord: searchValue })
    );
  }, 300);
                ...
                AllHadith?.hadiths?.length > 0 && (
                  <div className="pt-8 mx-auto">
                    <Pagination
                      ...
                      pagecount={AllHadith?.pagesCount}
